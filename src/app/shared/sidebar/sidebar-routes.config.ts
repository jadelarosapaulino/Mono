...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Productos', icon: 'ft-grid', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
        submenu: [
            { path: '/productos/nuevo', title: 'Agregar/Editar', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/productos/lista', title: 'Lista de productos', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
